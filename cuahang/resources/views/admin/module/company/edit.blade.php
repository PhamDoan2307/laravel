...
@section('title') Company-Sửa @endsection
@section('content')
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{route('admin.company.postEdit',$data->id)}}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$data->tel}}" class="form-control" name="tel"
                                       id="field-3"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="button">
                                    <button class="btn btn-secondary btn-single">Cập nhật</button>
