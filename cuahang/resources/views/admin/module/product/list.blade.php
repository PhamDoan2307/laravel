...
@section('title')Danh sách điện thoại @endsection
@section('content')
    {{--<div class="col-sm-12">--}}
        ...
        <div class="panel-body">
            ...
            <script type="text/javascript">
                jQuery(document).ready(function ($) {
                    $("#example-1").dataTable({
                        aLengthMenu: [
                            [5, 10, 25, 50, 100, -1], [5, 10, 25, 50, 100, "Tất cả"]
                        ]
                    });
                });
            </script>
                ...
                <table id="example-1" class="table table-striped table-bordered dataTable" cellspacing="0" width="100%"
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example-1" rowspan="1" colspan="1"
                            aria-label="Name: activate to sort column ascending" style="width: 150px;">Loại điện thoại
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="example-1" rowspan="1" colspan="1"
                            aria-label="Name: activate to sort column ascending" style="width: 150px;">Ảnh
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="example-1" rowspan="1" colspan="1"
                            aria-label="Name: activate to sort column ascending" style="width: 200px;">Giá
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="example-1" rowspan="1" colspan="1"
                    ...
                    <tr>
                        ...
                        <th rowspan="1" colspan="1">Loại điện thoại</th>
                    ...
                    @foreach($data as $dt)
                        <tr role="row" class="odd">
                            ...
                            <td>{{ $dt->group->name }}</td>
                            <td><img style="width: 100px;height: 100px" src="{{url('resources/upload/'.$dt->image)}}">
                            </td>
                            <td>{{ number_format($dt->price,0) }} VNĐ</td>
                            <td>{{ changeDate($dt->created_at) }}</td>
                            <td><a href="{{route('admin.product.getEdit',$dt->id)}}" style="color: red">Sửa</a>
                            </td>
