...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Đầu tiên",sLast:"Cuối",sNext:"Tiếp theo",sPrevious:"Trở lại"},
sEmptyTable:"Không có dữ liệu",sInfo:"Hiển thị _START_ tới _END_ của _TOTAL_ mục",sInfoEmpty:"Hiển thị 0 tới 0 của 0 mục",sInfoFiltered:"(Lọc qua _MAX_ mục)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ mục",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"Nhập từ khóa ",sUrl:"",sZeroRecords:"Không tìm thấy dữ liệu"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
